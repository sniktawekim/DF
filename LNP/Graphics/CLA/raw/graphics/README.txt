This Graphic set is intended to be used with "low-fi", ASCII-like tilesets with a tile size of 18x18px such as Haowan or Myne.


HOW TO USE:

1-put files from this rar (the folder 'CLA' and the textfiles) into raw/graphics and delete/move all other files in there.
